...
define('GMPAYS_WC_GATEWAY_VERSION', '1.0.0');
...
class GMPaysWooCommerceGateway {
    ...
    private function init_hooks() {
        ...
        register_activation_hook(GMPAYS_WC_GATEWAY_PLUGIN_FILE, array('GMPays_Activator', 'activate'));
        register_deactivation_hook(GMPAYS_WC_GATEWAY_PLUGIN_FILE, array('GMPays_Deactivator', 'deactivate'));
        register_uninstall_hook(GMPAYS_WC_GATEWAY_PLUGIN_FILE, array('GMPays_Deactivator', 'uninstall'));
    }
